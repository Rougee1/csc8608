...
DEFAULT_PROMPT = (
    "ultra-realistic product photo of a leather wallet on a white background, "
...
if mode == "Img2Img":
    ...
    if up is not None:
        ...
        st.image(init_image, caption="Input image", width="stretch")
...
if run:
    ...
    if mode == "Text2Img":
        ...
        img_in = init_image.resize((512, 512), Image.Resampling.LANCZOS)
        out = pipe_i2i(
            prompt=prompt,
            image=img_in,
